...
const { studentsModel } = require('../../model/relations');
...
studentRouter.put("/updatestudent/:id",bearerAuth,acl(['instructorDepartmentHead',"admin"]),handelDeleteStudent)
studentRouter.delete("/deletestudent/:id",bearerAuth,acl(['instructorDepartmentHead',"admin"]),handelUpdateStudent)
