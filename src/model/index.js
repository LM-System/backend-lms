...
const departmentsModel = require("./department/departments")(
  sequelize,
  DataTypes
);
const studentsCoursesModel = require("./user-course/studentsCourses")(
  sequelize,
  DataTypes
);
const instructorsCoursesModel = require("./user-course/instructorsCourses")(
  sequelize,
  DataTypes
);
const institutionModel = require("./institution/institution")(
  sequelize,
  DataTypes
);
...
const contentFileModel = require("./sections/contentFile")(
  sequelize,
  DataTypes
);
